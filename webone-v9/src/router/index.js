...
export default new Router({
  routes: [
    ...
    {path: '/userAgreements', name: 'userAgreements', component: userAgreements},
    {
      ...
      {path: '/businessOne', name: 'businessOne', component: businessOne, meta: {auth: true}},
      {path: '/businessOne/:id', name: 'businessOneDetail', component: businessOne, meta: {auth: true}},
      {path: '/businessBTCAccount', name: 'businessBTCAccount', component: businessBTCAccount, meta: {auth: true}},
      {path: '/', redirect: '/businessOne'},

<template>
  <div class="modifyPsd">
    <div class="title-user-profile green">修改登录密码</div>
    <div class="modifyPsd-content">
      <div class="modifyPsd-group1" style="display: none">
        ...
        <div class="form-group-content de">
          ...
          class="form-control OldModifyPsd"/>
      ...
      <div class="modifyPsd-group1">
        <span>新密码</span>
        <div class="form-group-content de">
          <input type="password" placeholder="密码" v-model="modifyPsd" class="form-control modifypsd" minlength="6" maxlength="32"/>
      ...
      <div class="modifyPsd-group1">
        <span>确认密码</span>
        <div class="form-group-content de">
          <input type="password" placeholder="确认密码" v-model="modifyPsds" class="form-control modifyPsds" minlength="6"
                 maxlength="32"/>

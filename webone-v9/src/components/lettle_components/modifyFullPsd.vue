<template>
  <div class="modifyFullPsd">
    <div class="title-user-profile green">修改资金密码</div>
    <div class="modifyFullPsd-content">
      <div class="modifyFullPsd-group1">
        <span>新密码</span>
        <div class="form-group-content de">
          <input type="password" placeholder="密码" v-model="modifyFullPsd" class="modifyFullpsd form-control" minlength="6"
                 maxlength="32">
      ...
      <div class="modifyFullPsd-group1">
        <span>确认密码</span>
        <div class="form-group-content de">
          <input type="password" placeholder="确认密码" v-model="modifyFullPsds" class="modifyFullPsds form-control" minlength="6"
                 maxlength="32"/>

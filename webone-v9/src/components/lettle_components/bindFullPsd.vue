<template>
  <div class="bindFullPsd">
    <div class="title-user-profile green">设置资金密码</div>
    <div class="bindFullPsd-content">
      <div class="bindFullPsd-group1">
        <span>密码</span>
        <div class="form-group-content de">
          <input type="password" placeholder="密码" v-model="bindFullPsd" class="form-control"/>
      ...
      <div class="bindFullPsd-group1">
        <span>确认密码</span>
        <div class="form-group-content de">
          <input type="password" placeholder="确认密码" v-model="bindFullPsds" class="form-control"/>

...
#chart_container.dark .chart_dropdown_t {
  background-image: url("../../src/assets/img/dropdown_w.png");
...
#chart_container.dark .chart_dropdown-hover.chart_dropdown_t {
  background-color: #0a0a0a;
  background-image: url("../../src/assets/img/dropup_w.png");
...
#chart_container.light .chart_dropdown_t {
  background-image: url("../../src/assets/img/dropdown_b.png");
...
#chart_container.light .chart_dropdown-hover.chart_dropdown_t {
  background-color: #fff;
  background-image: url("../../src/assets/img/dropup_b.png");
  background-position: right 9px;
  border-color: #4c4f53;
  color: #393c40
}
...
#chart_parameter_settings, #price_remind_settings, #borrowing_money_settings {
  border-radius: 4px;
  border-width: 1px;
  border-style: solid;
  width: 640px;
...
#chart_parameter_settings.clicked, #price_remind_settings.clicked, #borrowing_money_settings.clicked {
  visibility: visible;
}
...
#chart_parameter_settings td button {
  line-height: normal;
}
...
#chart_parameter_settings #close_settings, #price_remind_settings #close_sets, #borrowing_money_settings #close_set {
  border-radius: 4px;
  cursor: pointer;
  font-weight: bold;
  text-align: center;
...
#chart_parameter_settings #close_settings a, #price_remind_settings #close_sets a, #borrowing_money_settings #close_set a {
  background: #1887da;
  color: #eee;
}

#chart_parameter_settings .chart_str_default, #price_remind_settings .chart_str_default, #borrowing_money_settings .chart_str_default {
  margin-right: 24px
}

#chart_container.dark #chart_parameter_settings, #chart_container.dark #price_remind_settings, #chart_container.dark #borrowing_money_settings {
  background-color: rgba(0, 0, 0, 0.6);
  border-color: #aaa;
  color: #ccc
}

#chart_container.dark #chart_parameter_settings #close_settings, #chart_container.dark #price_remind_settings #close_sets, #chart_container.dark #borrowing_money_settings #close_set {
  background: #1887da;
  color: #eee
}
...
#chart_container.light #chart_parameter_settings #close_settings, #chart_container.dark #price_remind_settings #close_sets, #chart_container.dark #borrowing_money_settings #close_set {
  background: #1478c8;
  color: #eee
}
...
/*#price {text-align: center;font-size: 16px;font-weight: bold;height: 25px;line-height: 25px;}*/
...
#markettop.light a.selected {
  color: #f27935;
}

#markettop.dark a.selected {
  color: #ffac00;
}

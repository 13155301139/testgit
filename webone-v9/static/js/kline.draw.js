// var $URL_API = 'http://47.52.130.29:8089/bbjy/web/'
// var $URL_API = 'http://192.168.1.3:8089/bbjy/web/'
var $URL_API = 'https://api.egg.one/bbjy/web/';
...
var GLOBAL_VAR = {
  ...
  time_type: "line",
  market_from: this.$defaultCurrency,
  market_from_name: "BBJY",
  limit: "1000", // 显示的记录数目
  requestParam: "",
  chartMgr: null,
  G_HTTP_REQUEST: null,
  ...
  button_down: false,
  init: true,
  url: $URL_API + "quotation/kline/" + this.$defaultCurrency + "/MIN1",    // 获取所有数据的地址(ajax)
};
var Config = {
  currency: 'CNY',
  'kline': {
...
Chart.prototype.updateDataAndDisplay = function () {
  ...
  this.setTitle();
  ChartManager.getInstance().setCurrentDataSource("frame0.k0", "BBJY." + this._market_from + "." + this._time);
...
ChartManager.prototype.init = function () {
  ...
  DefaultTemplate.loadTemplate("frame0.k0", "BBJY");
  ...
  $(document).ready(GLOBAL_VAR.G_HTTP_REQUEST = $.ajax({
    ...
    success: function (res) {
      ...
      if (GLOBAL_VAR.G_HTTP_REQUEST) {
        GLOBAL_VAR.market_from_name = "BBJY";
...
function refreshTemplate() {
  GLOBAL_VAR.chartMgr = DefaultTemplate.loadTemplate("frame0.k0", "BBJY");
  ChartManager.getInstance().redraw("All", true)
}
